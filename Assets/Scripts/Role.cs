...
public class Role : MonoBehaviour
{
    ...
    public Role(string RoleName, string RoleFaction, string RoleDescription, string RoleGoal, RoleTypeEnum RoleType, Color32 RoleColor)
    {
    ...
    static Role()
    {
        ...
        {
            {"Villager", new Role("Villager", "Village", "Villager has to help the village win!", "Goal: You win with the village. Lynch every other faction.", RoleTypeEnum.Good, colorGreen)},
            {"Werewolf", new Role("Werewolf", "Werewolf", "Decide with your team (or alone if you are the only werewolf alive) who will you kill each night.", "Goal: Kill all other factions except the witch and be the only faction alive.", RoleTypeEnum.Evil, colorBrown)},
            {"Witch", new Role("Witch", "Evil Neutral", "Control one player each night (you find out his role next night). Decide who will your controlled victim visit.", "Goal: Live and win with the werewolf faction.", RoleTypeEnum.Neutral, Color.magenta)},
            {"Lover", new Role("Lover", "Village", "On the first night he picks a target to be his lover. The picked person will know that she got picked. If one of the lovers dies, the other one dies also from a broken heart. The lover can protect his target once.", "Goal: You win with the village. Lynch every other faction.", RoleTypeEnum.Good, colorPinky)},
            {"Doctor", new Role("Doctor", "Village", "Heal one person each night. If you save someone from an attack, you will know it.", "Goal: You win with the village. Lynch every other faction.", RoleTypeEnum.Good, colorCyan)},
            {"Mayor", new Role("Mayor", "Village", "Can reveal during the day. When revealed, his vote is worth 3 votes.", "Goal: You win with the village. Lynch every other faction.", RoleTypeEnum.Good, colorGold)},
            {"Sheriff", new Role("Sheriff", "Village", "You can investigate someone each night to see if they are a werewolf.", "Goal: You win with the village. Lynch every other faction.", RoleTypeEnum.Good, colorSilver)},
            {"Deputy", new Role("Deputy", "Village", "Has 1 bullet. He can't shoot on the first day. If he shoots a villager he pulls the trigger on himself due to the guilt.", "Goal: You win with the village. Lynch every other faction.", RoleTypeEnum.Good, colorDarkGreen)},
            {"Serial Killer", new Role("Serial Killer", "Evil Killing", "Can kill one person each night. Is immune to werewolf attack.", "Goal: You win on your own. Lynch every other faction.", RoleTypeEnum.Neutral, colorDarkBlue)},
            {"Jester", new Role("Jester", "Evil Neutral", "Get yourself lynched by any means necessary.", "Goal: You win on your own. Lynch yourself.", RoleTypeEnum.Neutral, colorPinkysh)}
        };
    }
    ...
    public static List<string> FetchPresetByPlayerCount(int playerCount)
    {
        ...
        {
            case 10:
                return new List<string> { "Werewolf", "Werewolf", "Doctor", "Mayor", "Lover", "Sheriff", "Villager", "Villager", "Villager", "Villager" };

            case 11:
                return new List<string> { "Werewolf", "Werewolf", "Doctor", "Mayor", "Lover", "Villager", "Villager", "Villager", "Villager", "Villager", "Villager" };
            ...
            default:
                GameObject.FindGameObjectWithTag("RoleDistribution").GetComponent<RoleDistribution>().errorMessageTXT.gameObject.SetActive(true);
